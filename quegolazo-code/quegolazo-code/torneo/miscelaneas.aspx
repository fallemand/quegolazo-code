                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="card theme-bg-color">
                                            ...
                                            <div class="content">
                                                ...
                                                <p><%#Eval("CantPartidosArbitradosEdicion") %> partidos en la Edición <br>
                                                   <%#Eval("CantPartidosArbitradosTorneo") %> partidos en el Torneo</p>                                                
                                            </div>
                                     ...
                                     <li>
                                        <div class="card theme-bg-color">
                                            ...
                                            <div class="content">
                                                ...
                                                <p><span class="glyphicon glyphicon-home"></span> <%#((Entidades.Cancha)Container.DataItem).domicilio %> <br>
                                                   <span class="glyphicon glyphicon-earphone"></span> <%#((Entidades.Cancha)Container.DataItem).telefono%> </p>                                                
                                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default small-arrows">
                        ...
                        <div class="panel-body panel-maxheight maxheight-md"></div>
                ...
                <div class="col-md-6">
                      <div class="panel panel-default small-arrows ">
                        <div class="panel-heading">
                          ...
                          <div class="panel-body panel-maxheight maxheight-md">
                                 <table class="table table-condensed table-hover">
                                        <thead>
                                            <tr>
                                                <th class="col-md-4 text-center" colspan="2">Equipo</th> 
