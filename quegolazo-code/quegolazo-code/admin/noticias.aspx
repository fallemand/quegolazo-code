                                ...
                                <fieldset class="vgNoticia">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 control-label">Edición</label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 control-label">Título</label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
                                            <label for="select" class="col-lg-2 control-label">Tipo Noticia</label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
                                            <label for="select" class="col-lg-2 control-label">Descripción</label>
                                            <div class="col-lg-10">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-1">Tipo Noticia</th>
                                            <th class="col-md-2">Edición</th>
