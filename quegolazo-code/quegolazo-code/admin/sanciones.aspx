                    ...
                    <ContentTemplate>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" data-parent="#accordion" href="#agregarSancion" aria-expanded="true" aria-controls="agregarSancion">
                                    <span class="glyphicon glyphicon-plus"></span>
                                    Agregar una Sanción  
                                </a>                                 
                            </div>
                            <div id="agregarSancion" class="panel-collapse collapse in mobile-collapse" role="tabpanel" aria-labelledby="headingOne">
                                        ...
                                        <fieldset class="vgSancion">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group" id="idDivMotivo">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <aspNew:NewDropDownList ID="ddlMotivo" runat="server" CssClass="form-control"></aspNew:NewDropDownList>
                                                    </div>
                                                </div>
