...
<body>
    ...
    Delegados:
        ...
        Domicilio: <input type="text" class="form-control" id="txtDomicilioDelegadoPrincipal" runat="server" name="domicilioDelegadoPrincipal" placeholder="Domicilio del Delegado Principal"><br />
         ...
         <asp:Button ID="btnAgregarDelegadoPrincipal" runat="server" Text="Agregar Delegado" OnClick="btnAgregarDelegadoPrincipal_Click" CssClass="btn btn-success causesValidation"/>
         <br />
         <br />
    &nbsp;<asp:Button ID="btnRegistrarEquipo" runat="server" Text="Registrar Equipo" OnClick="btnRegistrarEquipo_Click" CssClass="btn btn-success causesValidation"/>
