        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                fontSize = cX / 2;
                percentageText.style.top = ((settings.height / 2) - (fontSize / 1.5)).toString() + 'px';
                percentageText.style.color = '#60A64F';
                percentageText.style.font = fontSize.toString() + 'px Open Sans';
