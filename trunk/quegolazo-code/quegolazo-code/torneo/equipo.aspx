                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="col-md-2 col-xs-3">
                                            <a id='jugador-<%# ((Entidades.Jugador)Container.DataItem).idJugador.ToString() %>' class="popover-jugador" href="<%# Logica.GestorUrl.urlJugador(nickTorneo,idEdicion,idEquipo,int.Parse(Eval("idJugador").ToString())) %>" >
                                               <%# ((Entidades.Jugador)Container.DataItem).obtenerImagen(Utils.GestorImagen.GRANDE,"img-circle img-responsive center-block height-jugador","avatar-lg avatar-slider",true) %>
                                            </a>
                                            <!-- Popover del Jugador -->
